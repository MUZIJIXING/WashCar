...
class TrainMobileNetV2:
    def __init__(self, train_img_dir="data/data/train", test_img_dir="data/data/val", epoch=100, batch_size=32, learning_rate=0.0001, step_size=100, gamma=0.1):
        super().__init__()
        print("准备训练....")
        self.best_model_file = "mode/MobileNetV2_best_model.mod"
        self.last_model_file = "mode/MobileNetV2_last_model.mod"
        ...
        self.net.classifier[1] = torch.nn.Linear(self.net.classifier[1].in_features, 10)
